function SimuAtTwoVertices(epo_file, gii_file, vertex1_layer, vertex1_index, vertex2_layer, vertex2_index)
    spm('defaults','eeg');
    ...
    pref = sprintf('/home/smaiti/Danc_lab/Final_Experiments/simulated_data/sim_at_TWO_vertex_18527&20720_Layers3to9/sim_at_vertices_layer%d_vertex%d_layer%d_vertex%d_', vertex1_layer, vertex1_index, vertex2_layer, vertex2_index);
